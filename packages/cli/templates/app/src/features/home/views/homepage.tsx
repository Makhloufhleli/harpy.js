      ...
      <div className="relative z-10 container mx-auto max-w-7xl px-4 pt-20 pb-32">
        <div className="text-center mb-16">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            ...
            <a
              href="https://github.com/AcroBytes/harpy.js"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-8 py-4 bg-slate-800/50 hover:bg-slate-800 border border-slate-700 hover:border-amber-500 text-white font-bold rounded-xl shadow-xl transition-all hover:scale-105 text-lg"
            >
