...
describe("createCommand integration", () => {
  beforeEach(() => {
    ...
    (mockedFs as any).readJsonSync.mockImplementation(
      (p: any) => ({ scripts: {} }) as any,
    );
  ...
  it("creates project without i18n and strips i18n templates", async () => {
    ...
    (mockedPrompts as any).mockImplementation(async (q: any) =>
