        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                icon: "⚡",
                title: t(dict, "features.lightning.title"),
                desc: t(dict, "features.lightning.description"),
              },
              {
                icon: "🎯",
                title: t(dict, "features.zeroConfig.title"),
                desc: t(dict, "features.zeroConfig.description"),
              },
              {
                icon: "🏗️",
                title: t(dict, "features.nestjs.title"),
                desc: t(dict, "features.nestjs.description"),
              },
            ].map((feature) => (
              <div
                key={feature.title}
